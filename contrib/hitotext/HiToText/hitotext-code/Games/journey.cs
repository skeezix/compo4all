...
namespace HiGames
{
    class journey : Hiscore
    {
        ...
        public struct HiscoreData
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1965)]
            public byte[] UnusedC;
        }
        ...
        public override void SetHiScore(string[] args)
        {
            ...
            switch (rank)
            {
                case 0:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.HiScoreOnScreen, HiConvert.IntToByteArraySingleBCD(score, hiscoreData.HiScoreOnScreen.Length));
                    break;
                case 1:
        ...
        public override void EmptyScores()
        {
            ...
            HiConvert.ByteArrayCopy(hiscoreData.HiScoreOnScreen, HiConvert.IntToByteArraySingleBCD(0, hiscoreData.HiScoreOnScreen.Length));
