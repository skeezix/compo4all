...
namespace HiGames
{
    class ckong : Hiscore
    {
        ...
        public ckong()
        {
            ...
            m_gamesSupported = "ckong,ckonga,ckongjeu,ckongo,monkeyd,ckongb,ckongalc,ckongs,ckongg,kkgalax";
        ...
        public override void SetHiScore(string[] args)
        {
            ...
            switch (rank)
            {
                case 0:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.HiScore, HiConvert.ReverseByteArray(HiConvert.HexStringToByteArray(score.ToString("D6"))));
                    break;
                case 1:
