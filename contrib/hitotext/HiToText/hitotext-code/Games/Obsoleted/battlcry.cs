...
namespace HiGames
{
    class battlcry : Hiscore
    {
        ...
        public struct HiscoreData
        {
            ...
            public byte[] Score5;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] UnusedScore6;      
        }

        public battlcry()
        {
            // Max. score: 999,999,990
            m_numEntries = 5;
            m_format = "RANK|SCORE|NAME";
            m_gamesSupported = "battlcry";
        ...
        public override void EmptyScores()
        {
            ...
            HiConvert.ByteArrayCopy(hiscoreData.UnusedScore6, HiConvert.IntToByteArrayHexAsHex(0, hiscoreData.UnusedScore6.Length));
        ...
        public override string HiToString()
        {
            ...
            retString += String.Format("{0}|{1}|{2}", 1, HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score1) * 10, ByteArrayToString(hiscoreData.Name1)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 2, HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score2) * 10, ByteArrayToString(hiscoreData.Name2)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 3, HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score3) * 10, ByteArrayToString(hiscoreData.Name3)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 4, HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score4) * 10, ByteArrayToString(hiscoreData.Name4)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 5, HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score5) * 10, ByteArrayToString(hiscoreData.Name5)) + Environment.NewLine;
