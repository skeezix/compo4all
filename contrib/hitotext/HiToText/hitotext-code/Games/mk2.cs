...
namespace HiGames
{
    class mk2 : Hiscore
    {
        ...
        {
            m_numEntries = 15;
            m_format = "RANK|NAME|WINS";
            m_gamesSupported = "mk2,mk2chal,mk2r14,mk2r21,mk2r32,mk2r42,mk2r91";
        ...
        public override void SetHiScore(string[] args)
        {
            ...
            byte[] score = { 0xd0, 0x4c, 0x81, 0xff}; // it seems that is always the same bytes
            string name = args[1].ToUpper().Substring(0, 3);
            int wins = System.Convert.ToInt32(args[2]);
            ...
            int rank = NumEntries;
            if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins1)))
                rank = 0;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins2)))
                rank = 1;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins3)))
                rank = 2;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins4)))
                rank = 3;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins5)))
                rank = 4;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins6)))
                rank = 5;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins7)))
                rank = 6;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins8)))
                rank = 7;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins9)))
                rank = 8;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins10)))
                rank = 9;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins11)))
                rank = 10;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins12)))
                rank = 11;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins13)))
                rank = 12;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins14)))
                rank = 13;
            else if (wins > HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins15)))
                rank = 14;
            #endregion
            ...
            switch (rank)
            {
                case 0:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score1, score);
                ...
                case 1:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score2, score);
                ...
                case 2:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score3, score);
                ...
                case 3:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score4, score);
                ...
                case 4:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score5, score);
                ...
                case 5:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score6, score);
                ...
                case 6:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score7, score);
                ...
                case 7:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score8, score);
                ...
                case 8:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score9, score);
                ...
                case 9:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score10, score);
                ...
                case 10:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score11, score);
                ...
                case 11:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score12, score);
                ...
                case 12:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score13, score);
                ...
                case 13:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score14, score);
                ...
                case 14:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.Score15, score);
        ...
        public override string HiToString()
        {
            ...
            retString += String.Format("{0}|{1}|{2}", 1, ByteArrayToString(hiscoreData.Name1), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins1))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 2, ByteArrayToString(hiscoreData.Name2), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins2))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 3, ByteArrayToString(hiscoreData.Name3), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins3))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 4, ByteArrayToString(hiscoreData.Name4), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins4))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 5, ByteArrayToString(hiscoreData.Name5), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins5))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 6, ByteArrayToString(hiscoreData.Name6), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins6))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 7, ByteArrayToString(hiscoreData.Name7), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins7))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 8, ByteArrayToString(hiscoreData.Name8), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins8))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 9, ByteArrayToString(hiscoreData.Name9), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins9))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 10, ByteArrayToString(hiscoreData.Name10), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins10))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 11, ByteArrayToString(hiscoreData.Name11), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins11))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 12, ByteArrayToString(hiscoreData.Name12), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins12))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 13, ByteArrayToString(hiscoreData.Name13), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins13))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 14, ByteArrayToString(hiscoreData.Name14), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins14))) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 15, ByteArrayToString(hiscoreData.Name15), HiConvert.ByteArrayHexAsHexToInt(HiConvert.ReverseByteArray(hiscoreData.Wins15))) + Environment.NewLine;
