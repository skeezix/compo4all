...
namespace HiGames
{
     class missile : Hiscore
    {
        ...
        public missile()
        {
            ...
            m_gamesSupported = "missile,mcombat,mcombata,suprmatk,suprmatkd,sprmatkd";
        ...
        public string ByteArrayToString(byte[] data)
        {
            ...
            {
                if (data[i] == 0xd4)
                    sb.Append('T'); // Instead of 0x54, the first default score uses 0xd4 for 'T'
                else if (data[i] == 0x5b)
                    sb.Append(' ');
                else 
