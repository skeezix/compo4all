...
namespace HiGames
{
    class zookeep : Hiscore
    {
        ...
        public struct HiscoreData
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name11;
            public byte Separator11;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score12;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name12;
            public byte Separator12;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score13;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name13;
            public byte Separator13;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score14;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name14;
            public byte Separator14;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score15;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name15;
            public byte Separator15;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score16;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name16;
            public byte Separator16;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score17;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name17;
            public byte Separator17;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score18;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name18;
            public byte Separator18;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score19;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name19;
            public byte Separator19;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Score20;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Name20;
            public byte Separator20;
        ...
        public override string HiToString()
        {
            ...
            retString += String.Format("{0}|{1}|{2}", 11, HiConvert.ByteArrayHexToInt(hiscoreData.Score11), ByteArrayToString(hiscoreData.Name11)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 12, HiConvert.ByteArrayHexToInt(hiscoreData.Score12), ByteArrayToString(hiscoreData.Name12)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 13, HiConvert.ByteArrayHexToInt(hiscoreData.Score13), ByteArrayToString(hiscoreData.Name13)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 14, HiConvert.ByteArrayHexToInt(hiscoreData.Score14), ByteArrayToString(hiscoreData.Name14)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 15, HiConvert.ByteArrayHexToInt(hiscoreData.Score15), ByteArrayToString(hiscoreData.Name15)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 16, HiConvert.ByteArrayHexToInt(hiscoreData.Score16), ByteArrayToString(hiscoreData.Name16)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 17, HiConvert.ByteArrayHexToInt(hiscoreData.Score17), ByteArrayToString(hiscoreData.Name17)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 18, HiConvert.ByteArrayHexToInt(hiscoreData.Score18), ByteArrayToString(hiscoreData.Name18)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 19, HiConvert.ByteArrayHexToInt(hiscoreData.Score19), ByteArrayToString(hiscoreData.Name19)) + Environment.NewLine;
            retString += String.Format("{0}|{1}|{2}", 20, HiConvert.ByteArrayHexToInt(hiscoreData.Score20), ByteArrayToString(hiscoreData.Name20)) + Environment.NewLine;
