...
namespace HiGames
{
    class kamikcab : Hiscore
    {
        ...
        public kamikcab()
        {
            ...
            m_gamesSupported = "kamikcab,yellowcb,yellowcj";
        ...
        public override void EmptyScores()
        {
            ...
            HiConvert.ByteArrayCopy(hiscoreData.DeletedScore, HiConvert.IntToByteArrayHex(0, hiscoreData.DeletedScore.Length));
