...
namespace HiGames
{
    class roadrunn : Hiscore
    {
        ...
        public override void SetHiScore(string[] args)
        {
            ...
            hiscoreData.Score = HiConvert.HexStringToByteArray(score.ToString("X6"));
        ...
        public override string HiToString()
        {
            ...
            for (int i = 0; i < m_numEntries; i++)
            {
                ...
                retString += String.Format("{0}|{1}|{2}",
                    i + 1,
                    HiConvert.ByteArrayHexAsHexToInt(hiscoreData.Score) * 10,
