...
namespace HiGames
{
    class tmnt : Hiscore
    {
        ...
        public struct HiscoreData
        {
            ...
            //These are used so that if you were to score 33rd, it would tell you, but you cannot enter initials.
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 180)]
            public byte[] UnusedScores;
        ...
        public tmnt()
        {
            ...
            m_gamesSupported = "tmnt,tmntj,tmntua,tmht2p,tmnt2po,tmnt2pj,tmht,tmntu";
