...
namespace HiGames
{
    class ddragon : Hiscore
    {
        ...
        public ddragon()
        {
            ...
            m_gamesSupported = "ddragon,ddragonb,ddragonu,ddragonw,ddragnw1,ddragoua,ddragnba,ddragob2";
        ...
        public string ByteArrayToString(byte[] data)
        {
            ...
            {
                if (data[i] >= 0x21 && data[i] <= 0x3a)
                    sb.Append(((char)(((int)data[i]) + 65 - 0x21)));
                else if (data[i] == 0x3b)
                    sb.Append('.');
                else if (data[i] == 0x3c)
                    sb.Append(' ');
