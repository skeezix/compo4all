...
namespace HiGames
{
    class jackal : Hiscore
    {
        ...
        public jackal()
        {
            ...
            m_gamesSupported = "jackal,topgunr,topgunbl,jackalj";
        ...
        public override void SetHiScore(string[] args)
        {
            ...
            switch (rank)
            {
                case 0:
                    ...
                    HiConvert.ByteArrayCopy(hiscoreData.HiScore, HiConvert.ReverseByteArray(HiConvert.IntToByteArrayHex((score / 100), 2)));
