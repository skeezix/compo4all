...
namespace HiGames
{
    class subroc3d : Hiscore
    {
        ...
        public string ByteArrayToString(byte[] data)
        {
            ...
            for (int i = 0; i < data.Length; i++)
            {
                if (data[i] == 0x5d)
                    ...
                    sb.Append(' ');
                else sb.Append((char)(int)data[i]);
            }
        ...
        public override void EmptyScores()
        {
            ...
            HiConvert.ByteArrayCopy(hiscoreData.Name6, StringToByteArray("   "));
            HiConvert.ByteArrayCopy(hiscoreData.Name7, StringToByteArray("   "));
            HiConvert.ByteArrayCopy(hiscoreData.Name8, StringToByteArray("   "));
            HiConvert.ByteArrayCopy(hiscoreData.Name9, StringToByteArray("   "));
            HiConvert.ByteArrayCopy(hiscoreData.Name10, StringToByteArray("   "));
