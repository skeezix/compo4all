...
class Frontend:
    ...
    def __init__(self):
        ...
        self.window.set_title ( "Compo4All Manager" )
        ...
        # Note
        self.note_l = gtk.Label()
        self.note_l.set_markup ( "C4A Manager is for managing\nplayer profiles or configuration.\n\nLaunch games through...\n- C4A-MAME,\n- C4A compatible launcher,\n- C4A supporting game." )
        self.note_l.set_line_wrap ( True )
        self.note_l.set_alignment ( xalign=0.22, yalign=0.5 )
        self.note_l.show()
        self.left_vb.pack_start ( self.note_l )
